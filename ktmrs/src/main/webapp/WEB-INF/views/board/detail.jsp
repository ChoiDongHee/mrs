...
<body>
	...
	<div class="box">
		...
		<div class="box-body">
			...
			<div class="form-group">
				<label>작성자/myboard/resources/bootstrap/css/bootstrap.min.css</label> <input type="text" name="id" class="form-control"
			...
			<c:if test="${vo.image != null }">
				<div>				
				<img id="img" width="200" height="200" src="imgLoad.do?fileDir=&fileName=${vo.image}">
				</div>
			</c:if>
		</div>
