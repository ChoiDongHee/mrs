...
public class BoardController {
	...
	public String list(@ModelAttribute("pagingDTO") PagingDTO pagingDTO, Model model, @RequestParam(value = "pageNo", required = false) String pageNo) {

		pagingDTO.setPageSize(15); // 한 페이지에 보일 게시글 수
		pagingDTO.setPageNo(1); // 기본 세팅을 한후에 
		...
		pagingDTO.setTotalCount(boardService.boardCount()); // 게시물 총 개수
		
		
		 logger.debug("boardCount : {}", pagingDTO.getTotalCount());
